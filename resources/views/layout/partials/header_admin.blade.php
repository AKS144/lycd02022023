			...
			<div class="header">
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow main-drop">
						<a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
							<span class="user-img">
								<img src="{{asset('/assets_admin/img/profiles/admprofile.jpg')}}" alt="">
								<span class="status online"></span>
							</span>
						</a>
						<div class="dropdown-menu">
							<a class="dropdown-item" href="{{ url('admin') }}"><i data-feather="user" class="me-1"></i> Dashboard</a>
							<!-- <a class="dropdown-item" href="settings"><i data-feather="settings" class="me-1"></i> Settings</a> -->
						<!-- 	<a class="dropdown-item" href="login"> Logout</a> -->
							 <a class="dropdown-item" href="{{ route('logout') }}"
                       onclick="event.preventDefault();
                                         document.getElementById('logout-form').submit();">
                       <i data-feather="log-out" class="me-1"></i> {{ __('Logout') }}
                    </a>
