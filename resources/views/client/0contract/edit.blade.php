        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <form action="{{ route('contract.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="profile_id" class="form-control" value="{{ $contract->id }}"><br>
                    <input type="hidden" name="u_id" class="form-control" value="{{ $contract->userid }}"><br>
                    {{-- <input type="hidden" name="u_id" class="form-control" value="{{ $profiles->user_id }}"><br> --}}
                    {{-- <input type="hidden" name="name" class="form-control" value="{{ $profile->name }}"><br> --}}
                    <label>Mobile</label>
                    <input type="text" name="mobile" class="form-control" value="{{ $contract->userid }}"><br>
