							...
							<div class="page-title">
								<div class="row">
									...
									<div class="col-md-6 text-end">
										<a href="{{ route('jobpost.create') }}" class="btn btn-primary back-btn mb-4">Post a Project</a>
									</div>
								</div>
							</div>
																...
																<td class="text-end">																	
																	<a href="javascript:void(0);" style="color:orange;" data-bs-toggle="modal" data-bs-target="#show{{ $contracts->id }}">View</a>															
																			...
																			@if($contracts->contract_id !== NULL)
																				<b style="color:grey;">|</b> <a href="{{ route('projectcont',$contracts->id) }}" style="color:orange;" onmouseover="style='text-decoration:underline'" onmouseout="style='text-decoration:none'" class="proposal-button">Contract </a>  
																				<!-- <a href="{{ route('projectcont',$contracts->id) }}" target="_blank" style="text-decoration:none" onmouseover="style='text-decoration:underline'" onmouseout="style='text-decoration:none'" class="proposal-delete">See Contract </a> 																				 -->
																			@endif

																			@if($contracts->invoice == 1)
																				<b style="color:grey;">|</b> <a href="{{ route('invoice',$contracts->id) }}" style="color:orange;" onmouseover="style='text-decoration:underline'" onmouseout="style='text-decoration:none'" class="proposal-button">Invoice</a>
