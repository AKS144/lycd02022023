			...
			<div class="page-wrapper board-screen">
				<div class="content container-fluid">
					<div class="acc-content">
						...
						<div class="row">
							<div class="col-sm-12" style="background: url(https://lytaa.com/public/search_assets/img/LYTAAFinal.png) center / cover no-repeat;">
								<div class=""> 							
									...
									<div class="on-board field-card select-account select-btn">
										...
										<br>
											<form action="{{ route('client.store') }}" method="POST" id="client">
												@csrf
												<div class="row ">
					...
					<p>---------------------- OR ----------------------  </p>
													...
													<div class="col-md-12">
														<div class="form-group">
															<label class="focus-label" for="name">Name <span>*</span></label>
												...
												<div class="row">													
													...
													<div class="col-md-6">
														...
														<div class="form-group">
															...
															<input type="text" name="mobile" class="form-control" id="mobile" placeholder="Phone Number" value="{{ old('mobile') }}">
												...
												<div class="row">						
													<div class="col-md-6">
														<div class="form-group">
															...
															<select name="location_id" id="" class="form-select" required>
																<option>Select Location</option>
																@foreach($locations as $id => $locations)
																	<option value="{{ $id }}" {{ (isset($user) && $user->location ? $user->location->id : old('location_id')) == $id ? 'selected' : '' }}>{{ $locations ?? '' }}</option>
																@endforeach
															</select>
												...
												<div class="row">													
													  ...
													  <div class="col-md-6">
														...
														<input placeholder=" Confirm Password" id="confirmPassword" type="password" class="form-control @error('password') is-invalid @enderror" name="password_confirmation" required autocomplete="current-password">
														@if ($errors->has('password'))
															<span class="text-danger">{{ $errors->first('password') }}</span>
														@endif
													   </div>
											...
											<div class="col-md-6">		
														...
														<div class="form-group">
															<div class="text-center">
															<a href="{{ url()->previous() }}" class="btn btn-default"><button class="btn btn-prev prev_btn btn-back" name="" type="button">Back</button></a>								
																	{{-- <input  class="btn next_btn btn-primary btn-get btn-next" type="submit" value="Submit"> --}}
											...
											<div class="col-12 text-center text-end dont-have">Already Have Account ? <a href="{{url('/login')}}">Click here</a></div>
		...
		<script>
			...
			$("#client").validate({         
				...
				messages: {
						...
						mobile: {
							required: "Filed is requried",
							number: "Filed should be number",
							maxlength: "Phone number should be 10 digit",
							minlength: "Phone number should be 10 digit",
						},  
						password: {
							required: "Password is required",
							minlength: "Password must be at least 8 characters include one capital and one small letter, one number and one special character ",
