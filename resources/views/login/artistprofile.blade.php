								...
								<div class="multistep-form"> 
										...
										<div class="select-type">
											<div class="account-onborad onboard-head">
												...
												<div class="select-box d-flex justify-content-center">
													...
													<label class="employee-level free-lance-img accounts_type" data-id="freelance" for="freelance"><a href="signup-artist"><img src="https://kofejob.dreamguystech.com/template/assets/img/select-04.png" alt="" class="img-fluid"><span>Photographer</span></a></label>
													<input id="employee" class="accounts_type"  type="radio" name="credit-card" value="mastercard" />
													<label class="employee-level employee-img accounts_type" data-id="employee" for="employee"><a href="signup"><img src="https://kofejob.dreamguystech.com/template/assets/img/select-05.png" alt="" class="img-fluid"><span>Client</span></a></label>
												</div>
											</div>
									...
									<div class="on-board field-card">
										<div class="account-onborad complte-board back-home">
											...
											<a href="onboard-screen-employer.html" class="btn btn-primary"> Back to Home</a>
										</div>
									</div>
									<!-- /Completeing Register -->
								</div>
