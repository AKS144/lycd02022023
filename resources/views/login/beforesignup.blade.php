										...
										<div class="select-type">
											<div class="account-onborad onboard-head">
												...
												<input checked="checked" id="freelance"   type="radio" name="credit-card" value="visa" />
													<label class="employee-level free-lance-img accounts_type" for="freelance"><a href="{{ route('artist.social') }}"><img src="https://kofejob.dreamguystech.com/template/assets/img/select-04.png" alt="" class="img-fluid"><span>Photographer</span></a></label>
													<input id="employee" class="accounts_type"  type="radio" name="credit-card" value="mastercard" />
													<label class="employee-level employee-img accounts_type"  for="employee"><a href="{{ route('client.social') }}"><img src="https://kofejob.dreamguystech.com/template/assets/img/select-05.png" alt="" class="img-fluid"><span>Client</span></a></label>
												</div>
											</div>
