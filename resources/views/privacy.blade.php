...
<div class="container">
    <div class="row">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
                    refers to Lyta, Youth Hostel, Street, near Marriott Hotel, Miramar, Panaji, Goa 403001.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Country</strong> refers to: Goa, India</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to lytaa, accessible from <a href="https://www.lytaa.com/"
                        rel="external nofollow noopener" target="_blank">https://www.lytaa.com/</a></p>
            </li>
            <li>
        ...
        <ul>
            <li>By visiting this page on our website: <a href="https://www.lytaa.com/" rel="external nofollow noopener"
                    target="_blank">https://www.lytaa.com/</a></li>
        </ul>
