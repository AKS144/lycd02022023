                    ...
                    <div class="modal-info">
                        <div class="row">
                            <div class="col-6 col-md-6">
                                ...
                                <div class="form-group">
                                    <!-- <label for=""> -->
                                        <input type="radio" name="start_date" id="radio_1">
                                        One-Day
                                    <!-- </label> &nbsp; -->
                                    <label for="">
                                        <input type="radio" name="start_date" id="radio_2" checked>
                                        Multiple-day
                                    </label>
                                    ...
                                    <!-- <div id="dvPinYes"> -->
                                        <div class="row" id="date1">
                                            <div class="col-md-12" >
                                                ...
                                                <input type="date" name="start_date" id="start_date" class="form-control" value="{{ old('start_date', isset($job) ? $job->start_date : '') }}">
                                            </div>
                                        </div>
                                        <div class="row" id="date2">
                                            <div class="col-md-12" >
                                                ...
                                                <input type="date"  name="end_date" id="end_date" class="form-control" value="{{ old('end_date', isset($job) ? $job->end_date : '') }}">
                                            </div>
                                        </div>
                                    <!-- </div>  -->
                                </div>
