        ...
        <div class="row">
            ...
            <div class="col-md-8 " style=" padding:32px;">
                ...
                <div class="row">
                    ...
                    <p>Lorem Ipsum <b>{{ $contract->user_name }}</b> is simply dummy text of the printing and <b> {{ $contract->artist_name }} </b> typesetting
                        industry. Lorem
                        Ipsum has
                ...
                <div class="row">
                    <div class="col-6 text-center">
                        <img src="{{ asset('upload/'."$contract->artist_sign") ?? ''}}" width="90" height="90">   
                         <br>
                        <h6>
                            Artist signature</h6>
                    </div>
                    <div class="col-6 text-center">
                        <img src="{{ asset('upload/'."$contract->user_sign") ?? ''}}" width="90" height="90"> 
                       <br>
