										...
										<div class="card-body">
											<div class="table-responsive">
												<table class="table table-center table-hover mb-0 datatable">
													...
													<tbody>
														@foreach ($contracts as $key => $contracts)
															<tr>
																<td>
																	{{ $contracts->id ?? '' }}
																</td>
																...
																@if($contracts->status == 0)
																	<td>
																		<p class="text-success"><i class="fas fa-medal me-2"></i>Pending</p>
																	</td>
																@elseif($contracts->status == 1)
																	<td>
																		<p class="text-primary"><i class="fas fa-medal me-2"></i>Ongoing</p>
																	</td>
																@elseif($contracts->status == 2)
																	<td>
																		<p class="text-info"><i class="fas fa-medal me-2"></i>Completed</p>
																	</td>
																@elseif($contracts->status == 3)
																	<td>
																		<p class="text-danger"><i class="fas fa-medal me-2"></i>Cancelled</p>
																	</td>	
																@endif
																...
																<td class="text-end">																	
																	<a href="javascript:void(0);" style="color:orange;" data-bs-toggle="modal" data-bs-target="#show{{ $contracts->id }}">View</a>															
																										...
																										<div class="proposals-detail">
																											...
																											<div class="proposals-content">
																												...
																												<div class="proposal-client">
																													...
																													<h2 class="client-price">$599.00</h2><br />
																			...
																			@if($contracts->contract_id !== NULL)
																				<b style="color:grey;">|</b> <a href="{{ route('project.contract', $contracts->id) }}" style="color:orange;" onmouseover="style='text-decoration:underline'" onmouseout="style='text-decoration:none'" class="proposal-button">Contract </a>  
																			@endif

																			@if($contracts->invoice == 1 and $contracts->contract_id != NULL)
