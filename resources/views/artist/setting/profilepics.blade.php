											...
											<div class="form-group col-md-6 pro-pic">
												...
												<div class="d-flex align-items-center">													
													<div class="upload-images">
														@if(!empty($profile['profile_img']))
														<img style="margin-left: 34px; width:400px; height:250px" id="preview_img" src="{{ asset('profile_img/'."$profile->profile_img") }}"  id="profile_img">
														@elseif(empty($profile['profile_img']))
														<img style="margin-left: 34px;" id="preview_img">
														@endif
														<br/> <br/>
														<label style="margin-center: 30px;" class="file-upload image-upbtn ms-3">Upload<input type="file" name="profile_img" onchange="loadPreview(this);" class="form-control image"><br>
