                ...
                <div class="modal-body">                   
                    ...
                    <form action="{{ route('photos.store') }}" method="POST" enctype="multipart/form-data" id="form-upload">
                        ...
                        <div class="form-group mt-5">                           
                            <input type="file" id="drag-drop-area" class="form-control" name="photo[]" multiple required/>
					...
					@endif
                    <!-- <form action="{{ route('photos.store') }}" method="POST" enctype="multipart/form-data" id="drag-drop-area">
                        <input type="hidden" name="album_id" value="{{ $album->id }}">                       
                    </form> -->
                </div>
            </div>
