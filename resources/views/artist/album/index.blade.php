						...
						<div class="col-xl-9 col-md-8">
							...
							<div class="portfolio-item">
								<div class="pro-head p-0 pb-4">
									...
									<!-- <a class="btn btn-primary back-btn br-0" data-bs-toggle="modal" href="#portfolio">Add</a> -->
									<button type="button" data-bs-toggle="modal" href="#portfolio" class="btn btn-outline-success" style="border-radius:5px !important; font-size: 14px;">Add Genre</button>    							
								</div>
