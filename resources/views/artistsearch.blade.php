	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-12 col-lg-8 col-xl-12">
				...
				{{-- @if(Auth::check() != NULL) --}}
				<!-- <form action="{{ url('profile-search') }}" class="serach-form-area">
 			...
 			@if(Auth::check() == NULL)
				<form action="{{ url('profile-search') }}" class="serach-form-area">
					<div class="input-group hide-search-mobile" style="margin-bottom: 14px;">						
						...
						<input class="form-control autocomplete" name="search" type="text" placeholder="Search Here...." style="padding:17px; width:846px;border: #cfcfcf 2px solid; border-radius:11px 0px 0px 11px;">
						...
						<div class="col-md-3 col-lg-3 col-xl-3">
							<div class="freelance-content">
								...
								<div class="freelance-img">
									...
									<img src="{{ asset('profile_img/'."$profile->profile_img") }}" 
											alt="User Image">
											@else
										<img  src="{{ asset('assets/img/img-03.jpg') }}"
											alt="User Image">
											@endif
										@if(Auth::check() != NULL)
											<a href="{{ route('profshow', $profile->id) }}">{{ $profile->name }} </a> 
										@else
                   						    <a data-bs-toggle="modal" href="#login">{{ $profile->name }}</a>
										@endif
